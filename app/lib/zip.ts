// Minimal ZIP writer: deflate entries, local headers, central directory, end record.
// No zip64, so total size and entry count must stay under the 32-bit / 16-bit limits.
